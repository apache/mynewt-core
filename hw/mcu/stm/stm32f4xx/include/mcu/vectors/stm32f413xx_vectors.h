...
INT_VECTOR(CAN3_TX_IRQHandler)
INT_VECTOR(CAN3_RX0_IRQHandler)
INT_VECTOR(CAN3_RX1_IRQHandler)
INT_VECTOR(CAN3_SCE_IRQHandler)
INT_VECTOR_UNUSED(0)
INT_VECTOR_UNUSED(0)
...
INT_VECTOR(DFSDM2_FLT0_IRQHandler)
INT_VECTOR(DFSDM2_FLT1_IRQHandler)
INT_VECTOR(DFSDM2_FLT2_IRQHandler)
INT_VECTOR(DFSDM2_FLT3_IRQHandler)
