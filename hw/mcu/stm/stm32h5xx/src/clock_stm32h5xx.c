...
SystemClock_Config(void)
{
    ...
    __HAL_FLASH_SET_PROGRAM_DELAY(MYNEWT_VAL_STM32_FLASH_PROGRAM_DELAY);
    ...
    LL_RCC_HSI_SetDivider(MYNEWT_VAL_STM32_CLOCK_HSIDIV);
    ...
    if (PLL_ON(PLL1)) {
        BUSY_LOOP(PLL_VAL(PLL1, SOURCE) == LL_RCC_PLL1SOURCE_HSE &&
                  !LL_RCC_HSE_IsReady());
        BUSY_LOOP(PLL_VAL(PLL1, SOURCE) == LL_RCC_PLL1SOURCE_HSI &&
                  !LL_RCC_HSI_IsReady());
        BUSY_LOOP(PLL_VAL(PLL1, SOURCE) == LL_RCC_PLL1SOURCE_CSI &&
                  !LL_RCC_CSI_IsReady());
    ...
    if (PLL_ON(PLL2)) {
        BUSY_LOOP(PLL_VAL(PLL2, SOURCE) == LL_RCC_PLL1SOURCE_HSE &&
                  !LL_RCC_HSE_IsReady());
        BUSY_LOOP(PLL_VAL(PLL2, SOURCE) == LL_RCC_PLL1SOURCE_HSI &&
                  !LL_RCC_HSI_IsReady());
        BUSY_LOOP(PLL_VAL(PLL2, SOURCE) == LL_RCC_PLL1SOURCE_CSI &&
                  !LL_RCC_CSI_IsReady());
...
#if RCC_CR_PLL3ON
    if (PLL_ON(PLL3)) {
        BUSY_LOOP(PLL_VAL(PLL3, SOURCE) == LL_RCC_PLL1SOURCE_HSE &&
                  !LL_RCC_HSE_IsReady());
        BUSY_LOOP(PLL_VAL(PLL3, SOURCE) == LL_RCC_PLL1SOURCE_HSI &&
                  !LL_RCC_HSI_IsReady());
        BUSY_LOOP(PLL_VAL(PLL3, SOURCE) == LL_RCC_PLL1SOURCE_CSI &&
                  !LL_RCC_CSI_IsReady());
