...
#ifndef __MCU_STM32H5_BSP_H_
#define __MCU_STM32H5_BSP_H_
...
/*
 * Internal API for stm32h5xx mcu specific code.
 */
int hal_gpio_init_af(int pin, uint8_t af_type, enum hal_gpio_pull pull, uint8_t od);

struct hal_flash;
extern struct hal_flash stm32h5_flash_dev;

#ifdef __cplusplus
}
#endif

#endif /* __MCU_STM32H5_BSP_H_ */
