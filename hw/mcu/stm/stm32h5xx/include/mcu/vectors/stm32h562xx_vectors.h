...
INT_VECTOR(USART11_IRQHandler)
INT_VECTOR(SAI1_IRQHandler)
INT_VECTOR(SAI2_IRQHandler)
INT_VECTOR(GPDMA2_Channel0_IRQHandler)
INT_VECTOR(GPDMA2_Channel1_IRQHandler)
INT_VECTOR(GPDMA2_Channel2_IRQHandler)
INT_VECTOR(GPDMA2_Channel3_IRQHandler)
INT_VECTOR(GPDMA2_Channel4_IRQHandler)
INT_VECTOR(GPDMA2_Channel5_IRQHandler)
INT_VECTOR(GPDMA2_Channel6_IRQHandler)
INT_VECTOR(GPDMA2_Channel7_IRQHandler)
INT_VECTOR(UART7_IRQHandler)
INT_VECTOR(UART8_IRQHandler)
INT_VECTOR(UART9_IRQHandler)
INT_VECTOR(UART12_IRQHandler)
INT_VECTOR_UNUSED(0)
...
INT_VECTOR(I3C1_EV_IRQHandler)
INT_VECTOR(I3C1_ER_IRQHandler)
