...
#include "stm32h5xx_mynewt_hal.h"
...
#include <mcu/stm32h5xx_mynewt_hal.h>

/* hal_uart */
#include <stm32h5xx_hal_uart.h>
#include <mcu/stm32h5_bsp.h>
...
#define STM32_HAL_TIMER_TIM12_IRQ TIM12_IRQn
#define STM32_HAL_TIMER_TIM13_IRQ TIM13_IRQn
...
#define FLASH_PROGRAM_TYPE FLASH_TYPEPROGRAM_QUADWORD
/* Some STM32H5 devices don't have those filed */
#ifndef FLASH_CCR_CLR_OBKERR
#define FLASH_CCR_CLR_OBKERR 0
#endif
#ifndef FLASH_CCR_CLR_OBKWERR
#define FLASH_CCR_CLR_OBKWERR 0
#endif
#define STM32_HAL_FLASH_CLEAR_ERRORS()                                        \
    do {                                                                      \
        __HAL_FLASH_CLEAR_FLAG(FLASH_CCR_CLR_EOP |                            \
                               ...
                               FLASH_CCR_CLR_OBKERR |                         \
                               FLASH_CCR_CLR_OBKWERR |                        \
                               FLASH_CCR_CLR_OPTCHANGEERR);                   \
    } while (0)
