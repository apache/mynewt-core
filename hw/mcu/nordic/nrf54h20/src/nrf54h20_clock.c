...
static uint8_t nrf54h20_clock_hfxo_refcnt;
 ...
 */
int
nrf54h20_clock_hfxo_request(void)
{
    int started;
    uint32_t ctx;
    ...
    // assert(nrf54h20_clock_hfxo_refcnt < 0xff);
    // if (nrf54h20_clock_hfxo_refcnt == 0) {
    //     NRF_CLOCK_NS->TASKS_HFCLKSTART = 1;
    //     started = 1;
    // }
    // ++nrf54h20_clock_hfxo_refcnt;
 ...
 */
int
nrf54h20_clock_hfxo_release(void)
{
    int stopped;
    uint32_t ctx;
    ...
    // stopped = 0;
    // __HAL_DISABLE_INTERRUPTS(ctx);
    // assert(nrf54h20_clock_hfxo_refcnt != 0);
    // --nrf54h20_clock_hfxo_refcnt;
    // if (nrf54h20_clock_hfxo_refcnt == 0) {
