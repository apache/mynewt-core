...
// int
// nrf54h20_get_image_hash(uint8_t area_id, uint8_t hash[32])
// {
...
// bool
// nrf54h20_images_match(void)
// {
//     uint8_t active_slot_hash[32];
//     uint8_t pending_slot_hash[32];

//     if (nrf54h20_get_image_hash(FLASH_AREA_IMAGE_0, active_slot_hash) == 0 &&
//         nrf54h20_get_image_hash(FLASH_AREA_IMAGE_1, pending_slot_hash) == 0 &&
...
// static int
// nrf54h20_vflash_read(const struct hal_flash *dev, uint32_t address, void *dst,
//                         uint32_t num_bytes)
// {
...
//  */
// static int
// nrf54h20_vflash_write(const struct hal_flash *dev, uint32_t address,
...
// static int
// nrf54h20_vflash_erase_sector(const struct hal_flash *dev, uint32_t sector_address)
// {
//     (void)dev;
//     (void)sector_address;
...
// static int
// nrf54h20_vflash_sector_info(const struct hal_flash *dev, int idx,
...
// static int
// nrf54h20_vflash_init(const struct hal_flash *dev)
// {
//     struct nrf54h20_vflash *vflash = (struct nrf54h20_vflash *)dev;
//     const void *img_addr;
//     uint32_t image_size;
...
//     image_size = 0;
// #else
//     img_addr = ipc_nrf54h20_image_get(&image_size);
// #endif
...
// static const struct hal_flash_funcs nrf54h20_vflash_funcs = {
//     .hff_read = nrf54h20_vflash_read,
//     .hff_write = nrf54h20_vflash_write,
//     .hff_erase_sector = nrf54h20_vflash_erase_sector,
//     .hff_sector_info = nrf54h20_vflash_sector_info,
//     .hff_init = nrf54h20_vflash_init
// };

// struct nrf54h20_vflash nrf54h20_vflash_dev = {
//     .nv_flash = {
//         .hf_itf = &nrf54h20_vflash_funcs,
