...
// static struct nrf54h20_hal_spi nrf54h20_hal_spi0;

// static void
// nrf54h20_spi0_irq_handler(void)
// {
//     struct nrf54h20_hal_spi *spi = &nrf54h20_hal_spi0;
//     uint16_t xfr_bytes;
// #if MYNEWT_VAL(SPI_0_MASTER)
//     uint16_t len;
// #endif
...
// static int
// hal_spi_config_master(struct nrf54h20_hal_spi *spi,
...
// #if MYNEWT_VAL(SPI_0_SLAVE)
// static int
// hal_spi_config_slave(struct nrf54h20_hal_spi *spi,
//                      struct hal_spi_settings *settings)
// {
//     int rc;
//     uint32_t nrf_config;
...
// #if MYNEWT_VAL(SPI_0_MASTER)
// static int
// hal_spi_init_master(struct nrf54h20_hal_spi *spi,
//                     struct nrf54h20_hal_spi_cfg *cfg)
// {
//     NRF_GPIO_Type *port;
//     uint32_t pin;
...
//                    (uint32_t)nrf54h20_spi0_irq_handler);
...
// #if MYNEWT_VAL(SPI_0_SLAVE)
// static int
// hal_spi_init_slave(struct nrf54h20_hal_spi *spi,
//                    struct nrf54h20_hal_spi_cfg *cfg)
// {
//     NRF_GPIO_Type *port;
//     uint32_t pin;
...
//     return hal_spi_init_master(spi, (struct nrf54h20_hal_spi_cfg *)cfg);
// #endif
...
//     return hal_spi_init_slave(spi, (struct nrf54h20_hal_spi_cfg *)cfg);
// #endif
// }
...
// {
//     struct nrf54h20_hal_spi_cfg hal_cfg;
...
// #if MYNEWT_VAL(SPI_0_MASTER)
//     if (nrf54h20_hal_spi0.spi_xfr_flag) {
//         NRF_SPIM0_NS->INTENCLR = NRF_SPI_IRQ_DISABLE_ALL;
//         hal_spi_master_stop_transfer();
//         nrf54h20_hal_spi0.spi_xfr_flag = 0;
//         NRF_SPIM0_NS->INTENSET = SPIM_INTENSET_END_Msk;
//     }
// #endif
