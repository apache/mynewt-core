...
//
//static int
//nrf54h20_flash_wait_ready(void)
//{
//    int i;
//
//    for (i = 0; i < 100000; i++) {
...
//
//static int
//nrf54h20_flash_read(const struct hal_flash *dev, uint32_t address, void *dst,
//                       uint32_t num_bytes)
//{
...
// */
//static int
//nrf54h20_flash_write(const struct hal_flash *dev, uint32_t address,
...
//
//static int
//nrf54h20_flash_erase_sector(const struct hal_flash *dev, uint32_t sector_address)
//{
//    int sr;
//    int rc;
//
...
//
//static int
//nrf54h20_flash_erase(const struct hal_flash *dev, uint32_t address,
//                        uint32_t num_bytes)
//{
...
//        nrf54h20_flash_erase_sector(dev, sector_address);
...
//
//static int
//nrf54h20_flash_sector_info(const struct hal_flash *dev, int idx,
...
//
//static int
//nrf54h20_flash_init(const struct hal_flash *dev)
//{
//    return 0;
//}
//
//static const struct hal_flash_funcs nrf54h20_flash_funcs = {
//    .hff_read = nrf54h20_flash_read,
//    .hff_write = nrf54h20_flash_write,
//    .hff_erase_sector = nrf54h20_flash_erase_sector,
//    .hff_sector_info = nrf54h20_flash_sector_info,
//    .hff_init = nrf54h20_flash_init,
//    .hff_erase = nrf54h20_flash_erase,
//};
//
//const struct hal_flash nrf54h20_flash_dev = {
//    .hf_itf = &nrf54h20_flash_funcs,
