...
struct nrf54h20_uart_cfg {
    int8_t suc_pin_tx;                          /* pins for IO */
    int8_t suc_pin_rx;
    int8_t suc_pin_rts;
    int8_t suc_pin_cts;
};
const struct nrf54h20_uart_cfg *bsp_uart_config(void);
...
extern struct nrf54h20_vflash nrf54h20_vflash_dev;
