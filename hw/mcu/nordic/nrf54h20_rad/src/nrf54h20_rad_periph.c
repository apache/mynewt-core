...
static const struct nrf54h20_rad_uart_cfg os_bsp_uart0_cfg = {
...
static const struct nrf54h20_rad_hal_spi_cfg os_bsp_spi0s_cfg = {
...
static void
nrf54h20_rad_periph_create_timers(void)
{
    int rc;
...
static void
nrf54h20_rad_periph_create_uart(void)
{
#if MYNEWT_VAL(UART_0)
    int rc;
...
static void
nrf54h20_rad_periph_create_spi(void)
{
    int rc;
...
static void
nrf54h20_rad_periph_create_i2c(void)
{
#if MYNEWT_VAL(I2C_0)
    int rc;
...
static void
nrf54h20_rad_periph_create_trng(void)
{
    int rc;
...
void
nrf54h20_rad_periph_create(void)
{
    nrf54h20_rad_periph_create_timers();
    // nrf54h20_rad_periph_create_uart();
    // nrf54h20_rad_periph_create_spi();
    // nrf54h20_rad_periph_create_i2c();
    nrf54h20_rad_periph_create_trng();
}
