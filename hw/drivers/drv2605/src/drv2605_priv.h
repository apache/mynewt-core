...
#define DRV2605_FEEDBACK_CONTROL_FB_BRAKE_FACTOR_MASK           ((7) << DRV2605_FEEDBACK_CONTROL_FB_BRAKE_FACTOR_POS)
...
#define DRV2605_FEEDBACK_CONTROL_LOOP_GAIN_MASK                 ((3) << DRV2605_FEEDBACK_CONTROL_LOOP_GAIN_POS)
