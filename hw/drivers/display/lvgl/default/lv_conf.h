...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE <os/os_time.h>         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (os_time_ticks_to_ms32(os_time_get()))    /*Expression evaluating to current system time in ms*/
...
#define LV_BUILD_EXAMPLES MYNEWT_VAL(LVGL_EXAMPLES)
...
#define LV_USE_DEMO_WIDGETS MYNEWT_VAL(LV_USE_DEMO_WIDGETS)
#if LV_USE_DEMO_WIDGETS
    #define LV_DEMO_WIDGETS_SLIDESHOW 0
#endif

/*Demonstrate the usage of encoder and keyboard*/
#define LV_USE_DEMO_KEYPAD_AND_ENCODER MYNEWT_VAL(LV_USE_DEMO_KEYPAD_AND_ENCODER)

/*Benchmark your system*/
#define LV_USE_DEMO_BENCHMARK MYNEWT_VAL(LV_USE_DEMO_BENCHMARK)
...
#define LV_USE_DEMO_STRESS MYNEWT_VAL(LV_USE_DEMO_STRESS)

/*Music player demo*/
#define LV_USE_DEMO_MUSIC MYNEWT_VAL(LV_USE_DEMO_MUSIC)
...
/*Flex layout demo*/
#define LV_USE_DEMO_FLEX_LAYOUT MYNEWT_VAL(LV_USE_DEMO_FLEX_LAYOUT)
