...
#if MYNEWT_VAL(MAX3107_0)
struct max3107_dev max3107_0;

struct max3107_cfg max3107_0_cfg = {
#if MYNEWT_VAL(BUS_DRIVER_PRESENT)
    .node_cfg = {
    ...
    .crystal_en = MYNEWT_VAL(MAX3107_CRYSTAL_EN),
    .no_pll = MYNEWT_VAL(MAX3107_0_DISABLE_PLL),
    .allow_mul_4 = 1,
    .allow_mul_2 = 1,
};

struct uart_conf_port max3107_0_uart_cfg = {
