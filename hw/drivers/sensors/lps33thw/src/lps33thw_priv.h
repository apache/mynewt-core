...
LPS33THW_REGISTER_VALUE(LPS33THW_CTRL_REG2, LPS33THW_CTRL_REG2_SWRESET, 2, 0x08);
LPS33THW_REGISTER_VALUE(LPS33THW_CTRL_REG2, LPS33THW_CTRL_REG2_LOW_NOISE_EN, 1, 0x04);
