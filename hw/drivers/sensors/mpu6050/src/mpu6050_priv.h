...
int mpu6050_write8(struct sensor_itf *itf, uint8_t addr, uint8_t reg,
                      uint32_t value);
int mpu6050_read8(struct sensor_itf *itf, uint8_t addr, uint8_t reg,
                     uint8_t *value);
int mpu6050_read48(struct sensor_itf *itf, uint8_t addr, uint8_t reg,
                      uint8_t *buffer);
