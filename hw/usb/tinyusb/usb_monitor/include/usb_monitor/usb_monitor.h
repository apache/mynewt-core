...
#ifndef H_USB_MONITOR_
#define H_USB_MONITOR_
 ...
 */
typedef void (*usb_monitor_cb_t)(bool connected);
 ...
 */
void usb_monitor_register_cb(usb_monitor_cb_t cb);
 ...
 */
bool usb_monitor_is_connected(void);

#ifdef __cplusplus
}
#endif

#endif /* H_USB_MONITOR_ */
