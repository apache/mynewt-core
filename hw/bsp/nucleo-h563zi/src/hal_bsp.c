...
const struct stm32_uart_cfg os_bsp_uart2_cfg = {
    .suc_uart = USART2,
    .suc_rcc_reg = &RCC->APB1LENR,
    .suc_rcc_dev = RCC_APB1LENR_USART2EN,
...
const struct stm32_hal_i2c_cfg os_bsp_i2c3_cfg = {
    ...
    .get_pclk = STM32_I2C4_GET_CLOCK_FREQ,
...
hal_bsp_deinit(void)
{
    ...
    RCC->AHB1RSTR = 0x000AD003;
    RCC->AHB2RSTR = 0x001F1DFF;
    RCC->AHB4RSTR = 0x00111880;
    RCC->APB1LRSTR = 0xBFFEC1FF;
    RCC->APB1HRSTR = 0x0080022B;
    RCC->APB2RSTR = 0x017F7800;
    RCC->APB3RSTR = 0x0010F9E0;
    RCC->AHB1RSTR = 0;
    RCC->AHB2RSTR = 0;
    RCC->AHB4RSTR = 0;
    RCC->APB1LRSTR = 0;
