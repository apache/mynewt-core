...
#define ARDUINO_PIN_D2      MCU_GPIO_PORTA(12)
#define ARDUINO_PIN_D3      MCU_GPIO_PORTB(0)
#define ARDUINO_PIN_D4      MCU_GPIO_PORTB(7)
#define ARDUINO_PIN_D5      MCU_GPIO_PORTB(6)
#define ARDUINO_PIN_D6      MCU_GPIO_PORTB(1)
#define ARDUINO_PIN_D7      MCU_GPIO_PORTF(0)
#define ARDUINO_PIN_D8      MCU_GPIO_PORTF(1)
#define ARDUINO_PIN_D9      MCU_GPIO_PORTA(8)
#define ARDUINO_PIN_D10     MCU_GPIO_PORTA(11)
#define ARDUINO_PIN_D11     MCU_GPIO_PORTB(5)
#define ARDUINO_PIN_D12     MCU_GPIO_PORTB(4)
#define ARDUINO_PIN_D13     MCU_GPIO_PORTB(3)
#define ARDUINO_PIN_A0      MCU_GPIO_PORTA(0)
#define ARDUINO_PIN_A1      MCU_GPIO_PORTA(1)
#define ARDUINO_PIN_A2      MCU_GPIO_PORTA(3)
#define ARDUINO_PIN_A3      MCU_GPIO_PORTA(4)
#define ARDUINO_PIN_A4      MCU_GPIO_PORTA(5)
#define ARDUINO_PIN_A5      MCU_GPIO_PORTA(6)

#define ARDUINO_PIN_RX      ARDUINO_PIN_D0
#define ARDUINO_PIN_TX      ARDUINO_PIN_D1

#define ARDUINO_PIN_SCL     ARDUINO_PIN_A5
#define ARDUINO_PIN_SDA     ARDUINO_PIN_A4
