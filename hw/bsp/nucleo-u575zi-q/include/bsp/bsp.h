...
#define RAM_SIZE            (SRAM1_SIZE + SRAM2_SIZE + SRAM3_SIZE)

/* LED pins */
#define LED_1               MCU_GPIO_PORTC(7)
#define LED_2               MCU_GPIO_PORTB(7)
#define LED_3               MCU_GPIO_PORTG(2)
...
/* Arduino pins */
#define ARDUINO_PIN_D0      MCU_GPIO_PORTG(8)
#define ARDUINO_PIN_D1      MCU_GPIO_PORTG(7)
...
#define ARDUINO_PIN_A1      MCU_GPIO_PORTA(2)
