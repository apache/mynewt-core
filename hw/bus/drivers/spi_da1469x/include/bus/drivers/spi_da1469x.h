...
#ifndef HW_BUS_DRIVERS_SPI_DA1469X_DMA_H_
#define HW_BUS_DRIVERS_SPI_DA1469X_DMA_H_
...
/**
 * Initialize os_dev as SPI bus device for DMA usage
 *
 ...
 */
int bus_spi_da1469x_dev_init_func(struct os_dev *odev, void *arg);

/**
 * Create SPI bus device for DMA
 *
...
#endif /* HW_BUS_DRIVERS_SPI_DA1469X_DMA_H_ */
