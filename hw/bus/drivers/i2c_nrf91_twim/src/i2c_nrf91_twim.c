    ...
    while (1) {
        ...
        *task_start = 1;
        ...
        end_ticks = os_cputime_get32() +
                    os_cputime_usecs_to_ticks(MYNEWT_VAL(I2C_NRF91_TWIM_SCL_RECOVERY_DELAY_USEC));
...
static int
bus_i2c_nrf91_twim_init_node(struct bus_dev *bdev, struct bus_node *bnode, void *arg)
{
...
static int
bus_i2c_nrf91_twim_enable(struct bus_dev *bdev)
{
...
static int
bus_i2c_nrf91_twim_configure(struct bus_dev *bdev, struct bus_node *bnode)
{
    struct bus_i2c_dev *dev = (struct bus_i2c_dev *)bdev;
    struct bus_i2c_node *node = (struct bus_i2c_node *)bnode;
...
static int
bus_i2c_nrf91_twim_read(struct bus_dev *bdev, struct bus_node *bnode,
...
static int
bus_i2c_nrf91_twim_write(struct bus_dev *bdev, struct bus_node *bnode,
...
static int
bus_i2c_nrf91_twim_disable(struct bus_dev *bdev)
{
    struct bus_i2c_dev *dev = (struct bus_i2c_dev *)bdev;
    NRF_TWIM_Type *nrf_twim;
...
static const struct bus_dev_ops bus_i2c_nrf91_twim_ops = {
    .init_node = bus_i2c_nrf91_twim_init_node,
    .enable = bus_i2c_nrf91_twim_enable,
    .configure = bus_i2c_nrf91_twim_configure,
    .read = bus_i2c_nrf91_twim_read,
    .write = bus_i2c_nrf91_twim_write,
    .disable = bus_i2c_nrf91_twim_disable,
};
