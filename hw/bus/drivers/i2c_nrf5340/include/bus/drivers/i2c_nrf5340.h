 ...
 *
 * @return      0 on success, non-zero (SYS_E*) on failure
 */
int
bus_i2c_nrf5340_dev_init_func(struct os_dev *odev, void *arg);

/**
 * Create I2C bus device using nRF5340 TWIM peripheral
 *
...
#endif /* HW_BUS_DRIVERS_I2C_NRF5340_H_ */
