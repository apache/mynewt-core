...
MAKE_SHELL_CMD(tasks, shell_os_tasks_display_cmd, &tasks_help)
MAKE_SHELL_CMD(mpool, shell_os_mpool_display_cmd, &mpool_help)
MAKE_SHELL_CMD(date, shell_os_date_cmd, &date_help)
MAKE_SHELL_CMD(reset, shell_os_reset_cmd, &reset_help)
MAKE_SHELL_CMD(reset_cause, shell_os_print_reset_cause, &print_reset_cause_help)
MAKE_SHELL_CMD(lsdev, shell_os_ls_dev_cmd, &ls_dev_help)
