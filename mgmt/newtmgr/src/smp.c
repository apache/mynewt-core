...
static smp_tx_rsp_fn smp_tx_rsp;

static const struct mgmt_streamer_cfg smp_cbor_cfg = {
                   ...
                   struct os_mbuf *m)
{
    ...
    rc = smp_process_request_packet(&streamer, m);
    return rc;
}
